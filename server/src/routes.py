...
from models.api.audio_collections import CollectionData
...
async def get_audio_collection(audio_collection_id: int) -> CollectionData:
...
async def post_audio_collection() -> Response:
...
async def delete_audio_collection(audio_collection_id: int) -> Response:
...
async def post_audio_collection_member() -> Response:
...
async def delete_audio_collection_member(audio_collection_member_id: int) -> Response:
